...
# Need to switch this to check for these as a substring!
# df <- df[(df$EXPECM__ALL_ACTIVE_PROGRAMS__C %like% "FTR") |
#            (df$EXPECM__ALL_ACTIVE_PROGRAMS__C %like% "CCS")
#          (df$EXPECM__ALL_ACTIVE_PROGRAMS__C %like% "FRS"),
#          ]
...
hs_geo <- hs_geo[hs_geo$GEOID %in% bg_list,]
st_crs(hs_geo)
